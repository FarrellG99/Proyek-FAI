            ...
            @foreach($arrmobil as $rowmobil)
                <tr>
                    ...
                    <form action="/post_booking" method="post">
                      @csrf
                    <td><button type="submit" class="btn-primary" style="border:0; border-radius:50px; width: 100px; height: 50px;">Book !</button><br></td>
                    <td><input type="text" name="plattxt" value="{{ $rowmobil->platnomor }}"></td>
                    {{-- <td><input type="text" name="statustxt" value="{{ $rowmobil->status }}"></td> --}}
                    </form>
                </tr>
            @endforeach
          </table>
